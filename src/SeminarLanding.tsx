...
const slideAssets = {
  ...
  kuraBefore3: new URL('../images/蔵サウナ写真/kura3 before.JPG', import.meta.url).href,
  kuraAfter3: new URL('../images/蔵サウナ写真/kura3 after.png', import.meta.url).href,
  kuraBefore4: new URL('../images/蔵サウナ写真/kura4 before.JPG', import.meta.url).href,
  kuraAfter4: new URL('../images/蔵サウナ写真/kura4 after.png', import.meta.url).href,
  ...
  logoChatGPT: new URL('../images/logos/chatgpt-logo.svg', import.meta.url).href,
  logoGemini: new URL('../images/logos/gemini-logo.svg', import.meta.url).href,
  logoClaude: new URL('../images/logos/claude-logo.svg', import.meta.url).href,
  logoManus: new URL('../images/logos/manus-logo.png', import.meta.url).href,
};
...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'senaのAI使い分け実践',
    goalStatement: '役割を4つに固定して「どのAIを使うか」を迷わず決断',
    lines: [
      '議事録・TODO・長期案件はChatGPTに集約し、記憶と横断検索をハブ化',
      '現地動画や写真の読み込み〜生成はGeminiに集中させてスピード最優先',
      '長文資料や比較表づくりはClaudeで構造化し、論点を揃えてから仕上げる',
      '最終の日本語資料はManusでトーン調整し、社内配布用の言い回しを統一',
    ],
    media: {
      position: 'main',
      layout: 'grid',
      ...
      items: [
        {
          src: slideAssets.logoChatGPT,
          alt: 'ChatGPTのロゴ',
          caption: 'ChatGPT｜基盤AI',
          description: '記憶とチャット横断参照でプロジェクト全体を管理。毎週の議事録とTODOを常に更新。',
          tone: 'accent',
          fit: 'contain',
        },
        {
          src: slideAssets.logoGemini,
          alt: 'Geminiのロゴ',
          caption: 'Gemini｜視覚・解析',
          description: '動画解析・画像生成・修正を一手に担当。現調動画や図面を読み込んで提案ビジュアル化。',
          tone: 'default',
          fit: 'contain',
        },
        {
          src: slideAssets.logoClaude,
          alt: 'Claudeのロゴ',
          caption: 'Claude｜構造化',
          description: '長文や表の骨格づくりが得意。提案書の章立てや比較表、コード生成まで一気通貫。',
          tone: 'muted',
          fit: 'contain',
        },
        {
          src: slideAssets.logoManus,
          alt: 'Manusのロゴ',
          caption: 'Manus｜日本語仕上げ',
          description: '国産AIで敬語・用語を整える。社内配布資料や議事録を建築向け表現に最終調整。',
          tone: 'default',
          fit: 'contain',
        },
      ],
      footnote: '担当を決めておくことでチーム内の引き継ぎと検証がスムーズに。',
    },
    toggles: [
      {
        title: 'セカンドオピニオンの重要性',
        summary: '別AIにも同じ指示を投げて視点を増やす',
        detail: 'ChatGPTで作ったドラフトはClaudeやGeminiにも一度投げて比較。視点違いの提案や補強案を拾うことで品質が底上げされる。',
        tone: 'accent',
      },
      {
        title: 'ChatGPTがベースな理由',
        summary: '記憶と横断参照がワークフローの芯',
        detail: 'メモリ機能とチャット間の参照で長期案件の背景を維持。Gemini・Claude・Manusの成果物もChatGPTに紐づけておくと再利用が速い。',
        tone: 'muted',
      },
    ],
    bg: 'linear-gradient(135deg,#059669,#0f172a)',
