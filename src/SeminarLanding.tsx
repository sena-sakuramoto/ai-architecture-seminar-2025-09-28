...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'senaのAI使い分け',
    lines: [
      'ChatGPT：基本何でもやる。文から提案から何から何まで（メモリ機能で使いやすい）',
      'Gemini：動画解析、画像生成、画像修正、動画生成がメイン',
      'Claude：グラフや資料作成、コード生成がメイン',
      'Manus：資料作成（日本語に特化したAI）',
    ],
    toggles: [
      {
        title: 'セカンドオピニオンの重要性',
        summary: 'ベースのAIから一度離れて同じ質問を投げる',
        detail: 'ベースで使ってるAIから一回離れて同じ質問を投げてみること。人間世界でいうセカンドオピニオンを玉にすると、いつもと視点が違うから役に立つことを言ってくれることがある。',
        tone: 'accent',
      },
      {
        title: 'ChatGPTがベースな理由',
        summary: 'メモリ機能とチャット間参照で使いやすい',
        detail: 'ベースはやっぱり、メモリ機能、チャット間の会話内容を参照できるChatGPTは使いやすい。個人の作業スタイルを覚えてくれるので一貫した結果が得られる。',
        tone: 'muted',
      },
    ],
    bg: 'linear-gradient(135deg,#059669,#0f172a)',
